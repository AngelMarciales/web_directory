<template>
  <div class="main-content grid grid-cols-8 grid-rows-6 gap-4 shadow-lg border-2 border-gray rounded-box">
    <div class="col-span-4">
      <h2 class="title3">Calificación del restaurante:</h2>
    </div>
    <div class="col-span-3 col-start-6">
      <h2 class="title3">4.5 ☆☆☆☆☆ (504)</h2>
    </div>
    ...
    <div class="col-span-6 col-start-3 row-start-2">
      <div class="relative">
        <div class="bg-red-500 h-4 rounded-full" :style="{ width: '57.5%' }"></div> <!-- Reemplaza 80% con el porcentaje real -->
    ...
    <div class="col-span-6 col-start-3 row-start-3">
      <div class="relative">
        <div class="bg-red-500 h-4 rounded-full" :style="{ width: '35.7%' }"></div> <!-- Reemplaza 70% con el porcentaje real -->
    ...
    <div class="col-span-6 col-start-3 row-start-4">
      <div class="relative">
        <div class="bg-red-500 h-4 rounded-full" :style="{ width: '4.0%' }"></div> <!-- Reemplaza 60% con el porcentaje real -->
    ...
    <div class="col-span-6 col-start-3 row-start-5">
      <div class="relative">
        <div class="bg-red-500 h-4 rounded-full" :style="{ width: '2.0%' }"></div> <!-- Reemplaza 50% con el porcentaje real -->
    ...
    <div class="col-span-6 col-start-3 row-start-6">
      <div class="relative">
        <div class="bg-red-500 h-4 rounded-full" :style="{ width: '0.8%' }"></div>
